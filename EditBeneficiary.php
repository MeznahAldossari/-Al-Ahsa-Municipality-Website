                ...
                <div class="col-lg-6 col-md-6 form-container">
                    <div class="col-lg-8 col-md-12 col-sm-9 col-xs-12 form-box text-center">
                        <div class="heading mb-4">
                            <h2>تعديل اسم الجهة المستفيدة</h2>
                        </div>

                        <div class="form-input needs-validation" novalidate>


                            <input type="textfield" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="الرجاء تعديل أسم الجهة المستفيدة " required>

                           
                            
                        </div>
                        <div class="text-right mb-3">
                            <input type="submit" value="تعديل" class="btn" onclick="">
                        </div>
                    </div>
                </div>
            </div>
